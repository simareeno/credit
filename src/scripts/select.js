...
$('.select--mini').selectize({
	valueField: 'id',
	labelField: 'name',
	options: [
		{id: 1, money: numberWithSpace(accounts[1].accountSum), semi: ',51', cards: '0', schet: 'Другой счёт', schetNumber: accounts[1].accountNumber}
	],
	create: false,
	render: {
		option: function(item, escape) {
